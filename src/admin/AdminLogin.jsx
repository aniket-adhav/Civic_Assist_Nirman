    ...
    <div className="min-h-screen flex bg-[#f0f4ff]">
      <div className="hidden lg:flex w-[52%] flex-col relative overflow-hidden bg-gradient-to-br from-[#1d4ed8] via-[#2563eb] to-[#1e40af]">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-12">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/15 backdrop-blur border border-white/20 mb-6">
              <div className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" />
              <span className="text-white/90 text-[11px] font-bold tracking-widest uppercase">System Online</span>
            </div>
            <h1 className="text-5xl font-black text-white leading-tight tracking-tight">
              Admin<br />Control<br /><span className="text-blue-200">Center</span>
            </h1>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={s.label} className={`${s.color} backdrop-blur rounded-2xl p-4 border border-white/10`}>
                <i className={`fas ${s.icon} text-blue-200 text-base mb-3 block`} />
        ...
        <div className="relative z-10 p-10">
          <div className="flex items-center gap-2 text-blue-200/60 text-xs">
            ...
            <span>TLS 1.3 · AES-256 Encrypted · ISO 27001 Certified</span>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-[380px]">
          ...
          <div className="mb-8">
            <div className="w-16 h-16 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center mb-5">
              <i className="fas fa-user-tie text-blue-600 text-2xl" />
            </div>
            <h2 className="text-2xl font-black text-slate-900 tracking-tight">Welcome back,</h2>
            <h2 className="text-2xl font-black text-blue-600 tracking-tight">Admin Officer</h2>
            <p className="text-slate-400 text-sm mt-2">Sign in to access the administrative portal.</p>
            <p className="text-slate-300 text-xs mt-1">Default: ID <code className="bg-slate-100 px-1 rounded">ADM-00001</code> · Password <code className="bg-slate-100 px-1 rounded">admin123</code></p>
          </div>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Admin ID</label>
              <div className="flex items-center gap-3 border border-slate-200 rounded-xl px-4 py-3.5 bg-slate-50 focus-within:border-blue-400 focus-within:bg-white focus-within:ring-4 focus-within:ring-blue-50 transition-all">
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3.5 rounded-xl font-bold text-sm text-white bg-blue-600 hover:bg-blue-700 active:scale-[0.98] shadow-lg shadow-blue-200 hover:shadow-blue-300 transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2.5">
              {loading
